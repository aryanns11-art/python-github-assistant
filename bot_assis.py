...
class assistant:
    def __init__(self, name):
        ...
        self.user_response = ["hi", "hello", "hey", "how are you", "hola"]
    
        self.exit_response = ["bye", "goodbye", "see you later"]
...
print(f"{obj.name}: Hey there! I'm {obj.name}, your GitHub assistant.")
...
while True:
    ...
    while True:
            ...
            if user in obj.user_response:
                print(f"{obj.name}: {obj.respond()}")

            elif user in obj.github_dataset:
                print(f"{obj.name}: {obj.github_dataset[user]}")
                ...
                print(f"{obj.name}: Goodbye!")
                exit()

            else:
                print(f"{obj.name}: I don't understand that. Try a GitHub question.")
